...
public class ConditionsDetailsPage extends BasePage {
	...
	static {
		...
		tmp.put("Associations Table", "//body[@class='yui-skin-sam']/div[@class='content']/div[@class='contentOuter']/div[@class='contentInner']/div[@class='bodyContent']/form[@id='condition_form']/div[@id='condition_form:condition_tabView']/div[@id='condition_form:j_idt407']/fieldset[@id='condition_form:j_idt409']/div[1]");
		tmp.put("Assoc Table App Type", "//th[@id='condition_form:association_table:j_idt411']");
		tmp.put("Assoc Table Customer Set", "//th[@id='condition_form:association_table:j_idt414']");
		tmp.put("Assoc Table ID", "//th[@id='condition_form:association_table:j_idt417']");
		tmp.put("Assoc Table Priority", "//th[@id='condition_form:association_table:j_idt458']");
		tmp.put("Assoc Table Start Date", "//th[@id='condition_form:association_table:j_idt461']");
		tmp.put("Assoc Table End Date", "//th[@id='condition_form:association_table:j_idt461']");
